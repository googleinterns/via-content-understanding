...
class VideoClassifier(models.BaseModel):
	...
	"""
	def __init__(self, num_clusters=256, num_classes=, num_mixtures=2, fc_units, **kwargs):
		...
		video_input_shape = (80, 300, 1024)
		audio_input_shape = (80, 300, 128)
