...
def replace_video_id_with_expert_features_wrapper(precomputed_features):
    ...
    def wrapper(video_id, ids):
        ...
        return (tuple(expert_features), ids, missing_modalities)
...
def update_dataset_shape_wrapper(experts, language_model):
    ...
    def map_fn(expert_features, contextual_embeddings, missing_modalities):
        ...
        return expert_features, contextual_embeddings, missing_modalities
